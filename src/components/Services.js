    ...
    <>
      ...
      <Card>
        <div className="flex flex-col sm:flex-row shadow max-w-7xl mx-auto gap-4 p-4 flex-wrap">
          ...
          <div
            key={service.title}
            className="w-full max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
          >
